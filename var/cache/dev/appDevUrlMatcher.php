...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // app_lucky_apinumber
        if (0 === strpos($pathinfo, '/api/lucky/number') && preg_match('#^/api/lucky/number(?P<item>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_lucky_apinumber')), array (  '_controller' => 'AppBundle\\Controller\\LuckyController::apiNumberAction',));
        }
